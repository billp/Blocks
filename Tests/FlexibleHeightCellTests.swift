...
class FlexibleHeightCellTests: XCTestCase {
    ...
    func testThatFlexibleHeightCellsHaveTheCorrectHeight() {
        ...
        XCTAssertEqual(floor(cell3!.frame.size.height), cellHeight)
    }
    ...
    func testThatFlexibleHeightCellsAndFixedHeightCellsHaveTheCorrectTotalHeight() {
        ...
        // When
        renderer.updateSections([Section(id: "1",
                                         header: TestHeaderComponentFlexibleHeight().asBlock,
                                         footer: nil,
                                         items: models.asBlocks)],
                                animation: .none)
